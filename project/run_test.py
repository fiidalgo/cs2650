...
sys.path.insert(0, os.path.join(os.path.abspath(os.path.dirname(__file__)), 'tests/python'))

try:
    # Try to import the C++ implementation
    from src.naive import LSMTree
    ...
    from src.naive.lsm_tree_py import LSMTree
